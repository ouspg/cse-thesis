...
\DIFdelend \noindent \DIFdelbegin %DIFDELCMD < \bf %%%
\DIFdel{Jurmu M.\ (2007) Resource Management in Smart Spaces Using Context-Based Leases.}%DIFDELCMD < } %%%
\DIFdelend \DIFaddbegin \textbf{\DIFadd{Jurmu M.\ (2007) Resource Management in Smart Spaces Using Context-Based Leases.}} \DIFaddend University of Oulu, Department of Electrical and Information Engineering. Master’s Thesis, 77 p.

\begin{center}
\DIFdelbegin %DIFDELCMD < {%%%
\DIFdelend \textbf{\fontsize{16}{19pt}\selectfont ABSTRACT}\\
\DIFdelbegin %DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelend \end{center}

{\DIFaddbegin \bfseries \DIFaddend \noindent \DIFdelbegin %DIFDELCMD < \bf %%%
...
\DIFdelbegin %DIFDELCMD < {\bf \keywords %%%
\DIFdel{Ubiquitous computing, mobile computing, task-based computing, context-awareness, QoS.}\DIFdelend \DIFaddbegin \vspace{1\baselineskip}
\noindent\textbf{\DIFadd{Keywords: Ubiquitous computing, mobile computing, task-based computing, context-awareness, QoS.}}
\DIFaddend }
